function sbFixTrain(ntrls,handles)
...
try
    ...
    while trl <= ntrls && isRun
        ...
        fixDuration = str2double(get(handles.guiFixDuration,'String'));
...
%             indLoc = randi(9);
%         end
        indLoc = 5; % always paint center location
        prevLoc = indLoc;
        ...
        if isInWindow
            ...
            while toc(temptic) < fixDuration && isInWindow % maintin fix for 1 sec
